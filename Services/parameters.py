...
class Parameters:
    ...
    def __init__(self):
        ...
        self.max_id_limit = 50000 # id 为单增计数，超过需要重新清除计数值
        self.trucate = True # 允许 id 清楚标志位

        # 模型训练相关参数
        self.min_trainsize = 400 # 允许的部分最小训练集大小
        self.train_coff = 50 # 最大训练系数 max_trainsize/min_trainsize
        self.max_trainsize = 20000 #全部的记录训练
        self.batch_size = 100 # train bacth_size
